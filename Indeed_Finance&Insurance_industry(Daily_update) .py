...
#user-agent
Q=['Actuaries','Insurance%20Agents','Loan%20Officers','Teller','Accountant','Credit%20Analysts','Financial%20Analyst']
...
for q in Q:#First For Loop
    for l in L:#Second For LOOP
       ...
       df.to_csv("indeed1_Finance&Insurance_"+titlekey1+"_"+city1+".csv", mode='a', index=False, header=False)  
