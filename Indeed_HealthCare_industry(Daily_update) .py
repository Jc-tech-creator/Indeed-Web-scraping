...
#user-agent
Q=['Physical%20Therapist%20Assistants','Dental%20Hygienists','Surgical%20Technologists','Ultrasound%20Technologist','Respiratory%20Therapists','Medical%20Assistants','Dental%20Assistants','Covid%20tester','Occupational%20Therapy%20Assistants','Nuclear%20Medicine%20Technologists']
L=['Los%20Angeles','San%20Francisco','Seattle','San%20Jose','New%20York']
...
for q in Q:#First For Loop
    for l in L:#Second For LOOP
       ...
       df.to_csv("indeed_Healthcare_"+titlekey1+"_"+city1+".csv", mode='a', index=False, header=False)  
